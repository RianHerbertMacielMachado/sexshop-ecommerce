    ...
    >
      ...
      <div className="absolute inset-0 flex items-center container mx-auto px-4 md:px-12">
        <div>
          ...
          {banner.linkUrl && (
            <Link href={banner.linkUrl} className="inline-block px-6 py-2.5 bg-white text-violet-700 rounded-full font-bold text-sm hover:bg-violet-50 transition-colors">
              Conferir
            </Link>
          )}
        </div>
